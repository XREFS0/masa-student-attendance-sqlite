# Student Attendance Management Suite

Academic attendance logging desktop software providing automated roll-calls, daily absence tracking, date-range filtering, and student record exports.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-student-attendance-sqlite.git
   cd masa-student-attendance-sqlite
   ```
